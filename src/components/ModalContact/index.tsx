        ...
        <Container>
            ...
            <div className="buttons-contact">
                <ul className="example-2">
                    ...
                    <li className="icon-content">
                        <a href="https://www.github.com/yagofontanez" aria-label="GitHub" data-social="github">
                            <div className="filled"></div>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                    ...
                    <li className="icon-content">
                        <a
                            href="https://www.instagram.com/yago25__?igsh=MWE1bm9yZDduNjhncw%3D%3D&utm_source=qr"
            ...
            <div className="curriculo-contact">
